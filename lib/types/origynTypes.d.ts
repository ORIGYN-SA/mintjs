...
export declare type KnownError<T> = {
    error_code: T;
};
export declare type OrigynError = {
    text: string;
    error: object;
    number: BigInt;
    flag_point: string;
};
export declare type OrigynResponse<T, K> = {
    ok?: T;
...
export declare type EscrowRecord = {
    token: TokenType;
    token_id: string;
    seller: AccountType;
    lock_to_date?: number;
...
export declare type StakeRecord = {
    staker: AccountType;
    token_id: string;
    amount: BigInt;
};
export declare type TransactionIdType = {
    nat?: BigInt;
    text?: string;
    extensible?: any;
};
...
export declare type PricingConfigType = {
    flat?: {
        token: TokenType;
        amount: BigInt;
    };
...
export declare type AuctionConfigType = {
    start_price: BigInt;
    token: TokenType;
    reserve?: BigInt;
    start_date: number;
...
export declare type IcTokenType = {
    canister: Principal;
    decimals: BigInt;
    fee: BigInt;
    standard: {

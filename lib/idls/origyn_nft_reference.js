...
exports.default = ({ IDL }) => {
    ...
    const Nft_Canister = IDL.Service({
        ...
        collection_nft_origyn: IDL.Func([IDL.Opt(IDL.Vec(IDL.Tuple(IDL.Text, IDL.Opt(IDL.Nat), IDL.Opt(IDL.Nat))))], [Result_13], ['query']),
        collection_secure_nft_origyn: IDL.Func([IDL.Opt(IDL.Vec(IDL.Tuple(IDL.Text, IDL.Opt(IDL.Nat), IDL.Opt(IDL.Nat))))], [Result_13], []),
        ...
        manage_storage_nft_origyn: IDL.Func([ManageStorageRequest], [Result_10], []),

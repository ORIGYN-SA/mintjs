...
exports.AuthClient = exports.ERROR_USER_INTERRUPT = exports.IdbKeyVal = exports.LocalStorage = exports.IdbStorage = void 0;
/** @module AuthClient */
...
class AuthClient {
    ...
    static async create(options = {}) {
        ...
        const idleManager = ((_b = options.idleOptions) === null || _b === void 0 ? void 0 : _b.disableIdle)
            ? undefined
            : idleManager_1.IdleManager.create(options.idleOptions);
    ...
    async login(options) {
        ...
        if (!key) {
            ...
            this._key = key;
            await this._storage.set(storage_1.KEY_STORAGE_KEY, JSON.stringify(key));
        }
